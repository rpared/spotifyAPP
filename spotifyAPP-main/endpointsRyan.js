...
//let accessToken = 'BQCbK-Coy5y4Jq6rbDHXh_0G1ER0-355clWlihZe-tF4f9H7XNwEaxfL_E2OahLFJFXoOi1zulZQG0xodwrD7DFX5DCD18U7Y561BMFXhfEkMO3fwpqW5bh25t42ogZJYKlENu1ua30T0kEMcAIuuO4scR19m9AqJCn-QX6dm1c0MRG9A_nP_CKgBd5P_zY';
...
function getTrackPosition(trackData) {
  track = trackData; // Update the global track variable
...
$(document).ready(function () {
  $('#buttonPlay').on('click', function () {
    const trackId = CurrentlyPlayingId; // Replace with the actual track ID
    console.log(trackId);
